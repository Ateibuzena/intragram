...
- `GET /users/feed/post/:postId/comments` — lista de comentarios del post
- `POST /users/feed/post/:postId/comments` — body: `{ content }` — añade comentario con usuario del JWT
