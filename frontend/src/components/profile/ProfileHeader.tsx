								...
								<div className="mt-4 flex flex-wrap justify-center gap-2 xl:justify-start">
									...
									{onRefreshProfile && (
										<button
											...
											title="Sincronizar de nuevo con tu perfil de 42"
											className="flex items-center gap-1.5 rounded-full border border-ft-cyan/30 bg-ft-cyan/10 px-3 py-1 text-xs font-bold text-ft-cyan shadow-[0_0_15px_rgba(0,186,188,0.35)] transition-colors hover:bg-ft-cyan/20 hover:shadow-[0_0_20px_rgba(0,186,188,0.5)]"
										>
